...
public class PoetChatFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.rvMsgs.setAdapter(new ChatAdapter(messages, getContext()));
    ...
    private void initData() {
        ...
        messages.add(new ChatMsg(2, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(3, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(4, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(4, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(4, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(4, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
        messages.add(new ChatMsg(4, "“风调雨顺扬帆启，诗词之美在此地。”开启APP，如同踏进一个满载诗词韵味的仙境。您将邂逅李白、杜甫、李清照、辛弃疾、苏轼等诸多古代文人，他们在莲花阁、桃花源、断桥残雪等场景中，怡然自得地吟诵诗词。"));
