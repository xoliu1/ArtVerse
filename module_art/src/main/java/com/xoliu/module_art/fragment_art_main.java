...
public class fragment_art_main extends Fragment {
    ...
    private void initData(){
        ...
        mFragments.add(new ArtCard(R.drawable.view1,"让·弗朗索瓦·米勒 ","The Gleaners"," The Gleaners /拾穗者","让·弗朗索瓦·米勒",
                "1857年","布面油画","83.5cm × 111cm",
                "图片描绘了一个农村中最普通的情景：\n" +
                        "秋天，金黄色的田野看上去一望无际，画面最前方是三个农妇，在收割后的田地里弯腰捡拾遗留在地上的麦穗，三个农妇在画面上斜向排开，姿态各异，动作不同。\n" +
        ...
        mFragments.add(new ArtCard(R.drawable.view2,"克劳德·奥斯卡·莫奈"," woman with a Parasol-Madame Monet and her son","woman with a Parasol-Madame Monet and her son/撑阳伞的女人","克劳德·奥斯卡·莫奈",
                "1875年","布面油画","81x100 cm",
                "此画作于1875年，画中的人物是莫奈的第一任妻子卡米尔和他们的儿子。\n" +
                        "\n1870年6月，卡米尔与莫奈结婚。同年，普法战争爆发，导致画家这之后的生活更加潦倒，期间，莫奈最爱以卡米尔为模特画画，此画即是这段时间创作的。画中描绘的是一个晴天的早上，两母子在草地上漫步的场景。\n\n" +
                        "\n画面正中偏右站着一位撑阳伞的女士，而画面偏左较远处的是一位小男孩。画面下方是草坪，其细腻的笔触表现了背光和向阳的草地阴影变化。其中，撑阳伞的女士被明亮的阳光包围，她的伞面上方和背后都有明亮的白色笔触，腰间还有一抹黄色视觉焦点，和底下黄色野花相对映。整体表现出了人物的惬意心情以及其中的微风、蓝天的那种恬静美好。\n" +
                        "\n既是一幅活泼生动的人物画，而且从中也呈现了莫奈温馨幸福的家庭生活。"));

        mFragments.add(new ArtCard(R.drawable.view3,
                "文森特·梵高 ",
                "《星夜》",
                " 《星夜》",
                "文森特·梵高",
                ...
                "油彩、帆布",
                "73.7厘米 x 92.1厘米",
                "《星夜》是梵高在1889年入住法国圣雷米的圣保罗精神疗养院期间创作的。当时，梵高因为精神问题自愿入院治疗。疗养院环境相对宜人，园内有草地、菜园和果园，它为患病的梵高提供了一个安静的创作环境。\n" +
                        "\n" +
                        "这幅画的创作灵感可能源于梵高在疗养院的窗户外眺望的夜晚星空。梵高曾在给弟弟帖欧的信中提到，他“几乎每天晚上都需要去观察星星”，同时他也曾明确表示，他希望通过画作来表达“天空之夜更有生动、更色彩斑斓、更有辉煌的星星”。\n" +
                        "\n" +
                        "这幅画也可以被看作是梵高的精神世界的投射。梵高虽然身处困境，但他依然怀着对生活、自然和宇宙的热爱，这反映在他明亮而活泼的画作中。这幅画力量强大，饱含情感，把正面和负面的情绪都揉合在一起，从而创造出一个对生活痛苦和喜悦的深入表述。\n" +
                        "《星夜》是梵高的代表作之一，完成于他在法国南部的圣保罗精神疗养院。画面上方是旋转的天空，星星在夜空中形成漩涡状的图案，应用厚重、旋转的笔触使画面产生动态和强烈的视觉冲击。画面下方则是一座静静的小镇，“大地”与“天空”的对比形成了强烈的视觉效果。画中的月亮和星星等元素都具有象征意义，反映了梵高对宇宙和生命的深度思考。"));

        mFragments.add(new ArtCard(R.drawable.view4,
                "保罗·德拉罗什",
                "《圣罗马诺之战》",
                " 《圣罗马诺之战》",
                "保罗·德拉罗什",
                ...
                "油彩、画布",
                "361厘米 x 510厘米",
                "《圣罗马诺之战》描绘的是1515年的马里尼亚诺战役，这场战役在法国历史上具有十分重要的地位。而保罗·德拉罗什是在1836年创作了这幅画，这一时期正是欧洲浪漫主义的高峰。\n" +
                        "\n" +
                        "浪漫主义注重情感的表达以及个人的主观经验，因此，德拉罗什在创作这幅画时，可能积极寻求以艺术的方式表现出混乱、激动人心的战场景象。同时，他可能也希望以此来重新点燃法国人的民族自豪感，因为这场战役巩固了法国的领土和弗朗索瓦一世的国王地位。\n" +
                        "\n" +
                        "\n另外，德拉罗什是在法国浪漫主义画派中具有重要地位的画家，他的作品体现了浪漫主义对英勇与豪迈的热衷，以此来激起观者的情感反应。因此，《圣罗马诺之战》中的戏剧性以及生动的场面也是德拉罗什作为浪漫主义画家的艺术手法的体现。\n" +
                        "\n《圣罗马诺之战》是法国浪漫主义画家保罗·德拉罗什的一幅重要作品。 " +
                        "\n这幅画展示的是法国历史上的一场关键战役——1515年的马里尼亚诺战役，这一战役巩固了法国国王弗朗索瓦一世的权力，并使法国在意大利占据了优势地位。画面描绘了战场上生死瞬息，形象鲜明，颇具戏剧性。画面的主要事物——半人马和狮子交战的场面，是德拉罗什借用神话来象征战争的混乱和残酷。" +
                        "\n这幅画曾在1836年的巴黎沙龙展览上展出，当时引起了广大的关注和热烈的讨论。德拉罗什的大胆构图和饱满的色彩，使这幅画具有很高的艺术及历史价值。"));


        mFragments.add(new ArtCard(R.drawable.view5,
                "文森特·梵高 ",
                "J.T. Tepnapa",
                " 《犹大之吻》1305",
                "乔托/J.T. Tepnapa",
                ...
                "\n乔托《犹大之吻》聚焦于基督和犹大之间心理交锋的瞬间。" +
                        ...
                        "\n在指控、欺骗和背叛的喧嚣中，基督保持着始终如一的怜悯。乔托首次赋予形象鲜明的人性动机，以及传统绘画欠缺的心理深度与逼真感。"));
