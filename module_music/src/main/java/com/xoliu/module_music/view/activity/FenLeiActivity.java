...
public class FenLeiActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/rensheng/lizhi"), "励志");
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/shanshui"), "山水");
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/jieri"), "节日");
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/rensheng/shiguang"), "时光");
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/rensheng/zhanzheng"), "战争");
        poetryPagerAdapter.addFragment(new PoetryListFragment("https://v1.jinrishici.com/rensheng/zheli"), "哲理");
